...
\begin{subequations}
    ...
    \begin{align}
        {\pVapor}{\volume[]{}[]} &= {\zVapor}{\vaporMole}{\universalConstantGas}{\tVapor}  \quad \text{(Para el Vapor)} \label{eqn:vapor} \\
        {\pGas}{\volume[]{}[]}   &= {\zGas}{\gasMole}{\universalConstantGas}{\tGas}  \quad \text{(Para el Gas)} \label{eqn:gas}
    \end{align}
\end{subequations}
