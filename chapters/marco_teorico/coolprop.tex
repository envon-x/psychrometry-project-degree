\begin{equation}
\frac{\alpha(r, \delta)}{\idealConstantGas \temperature[]{}} = \alpha^0(\tau, \delta) + \alpha^r(\tau, \delta)
\end{equation}
...
\begin{equation}
    \pressure[]{}(\delta, \tau) = \rho {\idealConstantGas \temperature[]{}} \left[ 1 + \delta \left( \frac{\partial \alpha^r}{\partial \delta} \right)_\tau \right]
\end{equation}
