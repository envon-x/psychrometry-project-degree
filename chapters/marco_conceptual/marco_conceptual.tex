...
\subsection{Conceptos ambientales}
    \begin{description}
...
\subsection{Definiciones químicas}
    \begin{description}
...
\subsubsection{Conceptos de Equilibrio de Fases}
    \begin{description}
...
\subsection{Magnitudes Termodinámicas Fundamentales}
    \begin{description}
        \item[Calor:] 
        \item[Temperatura:] 
...
%         \begin{figure}[h]
%             \centering
%             \input{collections/diagrams/adiabatic_saturation_temperature.tex} % Llamada al segundo módulo
