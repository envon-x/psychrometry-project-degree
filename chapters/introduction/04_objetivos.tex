...
\label{chap:sec:objetivos}
    ...
    \subsection{OBJETIVOS ESPECÍFICOS}
        \begin{itemize}
            % \item Desarrollar una aplicación para múltiples mezclas vapor-gas la información que permita construir las cartas psicrométricas hospedados en la nube en base a una combinación de variables.
            % \item La variable principal será presión atmosférica.
            % \item Proveer a los técnicos en el area de ingeniería de una app fácil de leer las variables psicrométricas
            ...
            \item Desarrollar la aplicación en el lenguaje de programación \ldp, de manera que permita la extensión a mezclas diferentes vapor del líquido - gas seco.
            \item Implementar para la mezcla vapor de agua-aire seco, de manera predeterminada.
            % \item Implementar para la mezcla de vapor de $\ce{CO2}$ y aire seco.
            % \item Implementar el diagrama psicrométrico para la mezcla, Benceno - Nitrógeno.
            ...
            \item Justificar el uso de la ecuación de gases ideales respecto a la ecuación virial de gases para las mezclas de vapor de agua $-$ aire seco. %, a una presión definida.
            ...
            % \item Sugerir a la \acrfull{rae}, la corrección del significado dado a la palabra, \textit{climatizar}.
            ...
            % \item buscador, numero de búsquedas, tiempo que les a tomado, tipo de pc, proveedor de internet, calidad del producto encontrado (tiempo de aprendizaje con la app y sin app, formato de la imagen pdf, jpeg. fuente de obtención, elaboración, link, sistema operativo)
