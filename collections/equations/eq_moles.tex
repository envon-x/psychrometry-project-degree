    ...
    \begin{subequations}
        ...
        \begin{align}
            \vaporMoleFraction + \gasMoleFraction = 1 \label{eq:SumVapGasFrac}\\ %No dejar espacio entre las ecuaciones
             \gasMoleFraction = 1 - \vaporMoleFraction \label{eq:GasFracAsFrac}
        \end{align}
    \end{subequations}
}
...
\newcommand{\eqMoleGasFractionAsAbsoluteHumidity}{
    \begin{equation}
        \label{eq:MoleGasFractionAsAbsoluteHumidity}
        \gasMoleFraction = 1 - \frac{{\absoluteHumidity}}{{(\frac{\vaporMolecularWeight}{\gasMolecularWeight} + \absoluteHumidity)}}
    \end{equation}
}
