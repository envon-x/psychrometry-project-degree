  ...
  \def\tituloAOptarVal{\gradoAcademico} % variable: tituloAOptarVal: para  usar dentro de la macro
  ...
  % Carrera donde se ha cursado los estudios
  \def\carreraVal{}
  \newcommand{\carrera}[1]{
    \def\carreraVal{
      #1
  ...
  \newcommand{\escalaImagenPortada}[1]{
    \def\escalaImagenPortadaVal{#1}     %% Cuando se llama a \escalaImagenPortada{0.5}, el valor de \escalaImagenPortadaVal se establecerá en 0.5.
  }
  ...
  \textit{Memoria que presenta para optar al título de: Ingeniero Aeroespacial}  \\ [0.3em]%
  ...
  \newcommand{\makeCover}{
    ...
    % recibe los centímetros de margen que quieres en cada lado, y él se
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{cambiamargen}{-\cambioIzquierdo}{-\cambioDerecho}
      ...
      % \vspace*{-\footskip}
        ...
        \begin{large}
          \begin{center}
            \textbf{\fontsize{20}{0}\selectfont \institucionVal}\\[5mm]
          \end{center}
        \end{large}
        ...
        \begin{large}
          \begin{center}
            \textbf{\fontsize{16}{0}\selectfont \facultadVal}\\[1mm]
          \end{center}
        \end{large}
        ...
        \begin{large}
          \begin{center}
            \textbf{\fontsize{16}{0}\selectfont \carreraVal}\\[1mm]
          \end{center}
        \end{large}
        ...
        \begin{center}
          \vfill
          \includegraphics[width=3.5cm, height=8cm]{\imagenPortadaVal}
          \\[5mm]
        \end{center}

        %%En virtud de los requerimientos de diseño para la UMSA, se ha deshabilitado
        % \begin{Huge}
        %   \begin{center}
      ...
      \begin{large}
        \begin{center}
          % \vskip 1cm
          \textbf{
            \fontsize{16}{25}\selectfont {\tituloPortadaVal} 
          }
        \end{center}
      \end{large}
      ...
      \begin{large}
        \begin{center}
          ...
          \fontsize{11}{0}\selectfont {
            \textbf{Proyecto de Grado para Obtener el Título de \tituloAOptarVal}\\[4mm]
          }
        \end{center}
      \end{large}

      % \enlargethispage{2cm} % aumenta el tamaño de la página en 2cm

      \begin{normalsize}
        \begin{center}
        \fontsize{16}{0}\selectfont {
          \textbf{ POR: \autorPortadaVal}\\[5mm]
        }
